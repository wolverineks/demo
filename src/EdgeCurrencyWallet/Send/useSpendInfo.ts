import { EdgeCurrencyWallet, EdgeMemo, EdgeMetadata, EdgeSpendInfo, EdgeTokenId } from 'edge-core-js'
...
export const useSpendInfo = (wallet: EdgeCurrencyWallet, tokenId: EdgeTokenId) => {
